...
public class AvatarEmotion : MonoBehaviour
{
    ...
    private string _username_STT = "0080f8de-6a51-4cb6-b7ca-74dfc91e46a8";     private string _password_STT = "hQqTQuoIgYBj"; 	private string _url_STT = "https://stream.watsonplatform.net/speech-to-text/api";
